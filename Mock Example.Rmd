...
salpha_PFS[1,] <- c(0.005, 0.025*2/3, 0.025) ## PFS: T2 vs. T0
salpha_PFS[2,] <- c(0.005, 0.025*1/3, 0.025) ## PFS: T1 vs. T0 
...
for (i in 1:2){
  g_PFS[i,] <- crit.value.g(salpha_PFS[i,], zcorr_PFS[[i]], sided=1)
}
...
c_PFS <- g_PFS - w[1]*matrix(X_PFS[,1], 2, length(t_IAs) - 1)
